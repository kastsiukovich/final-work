...
let counter = function () {
   ...
   //    console.log(+counterBasketResult.innerText != 0)
   //    return
   // }else{
   // console.log(localStorage.getItem('saveResult'))
   // if(localStorage.getItem('saveResult')!=0){
   //    return counterBasketResult.innerText =localStorage.getItem('saveResult')
   // }
   // else{
...
const saveContentCartBasket = () => {
   ...
   // let quantity = quantity.innerText;
   // if (+saveResult != 0) {
   // let saveContentCart = 55555555555;
